...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '0.0.0.0', '51.222.136.185', 'bd.julsql.fr', 'bd', 'testserver']
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'main/core/infrastructure/interface_adapters/templates',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Facultatif : active aussi le format des dates françaises
