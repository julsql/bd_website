...
SAMBRE_DATA = {
    ...
    'BDFUGUE': {
        'Album': "hiver 1931",
        'Série': "La guerre des sambre - Hugo et Iris",
        'Numéro': "3",
        'Scénario': "Yslaire",
        'Dessin': "Jean Bastide,Vincent Mézil",
        'Couleurs': "Jean Bastide,Vincent Mézil",
...
THORGAL_DATA = {
    'BDPHILE': {
        ...
        'Éditeur': "Le Lombard",
        'Édition': 'Édition originale - 18 rééditions Les 2 premiers tomes sont parus '
                   'en même temps. Tome 3 à paraître au 4e plat',
        'Date de publication': "1980-01-01",
        'Pages': 48,
        'Prix': 10.0,
    ...
    'BDFUGUE': {
        ...
        'Dessin': "Grzegorz Rosinski",
        'Éditeur': "LOMBARD",
        'Date de publication': "1996-06-07",
        'Pages': 48,
        'Prix': 6.0,
...
SAULE_DATA = {
    'BDPHILE': {
        'Album': "Le bois sauvage",
        'Série': "Le Vent dans les saules",
        'Numéro': "1",
        'Scénario': "Michel Plessix",
        'Dessin': "Michel Plessix",
        'Éditeur': "Delcourt",
        'Édition': '6 rééditions',
